...
| API unit                          | **22** | env/config validation, and 13 Deepgram **contract tests** against a local server speaking its documented wire protocol                                                                      |
...
restart, recovered in **1 s**. <sub>Regenerated by `make readme-stats` — last run 2026-07-21.</sub>
<!-- END:test-results -->
